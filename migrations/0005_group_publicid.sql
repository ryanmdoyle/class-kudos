...
INSERT INTO "new_Group" ("archived", "description", "enrollId", "id", "name", "ownerId", "rewardedPoints") SELECT "archived", "description", "enrollId", "id", "name", "ownerId", "rewardedPoints" FROM "Group";
DROP TABLE "Group";
